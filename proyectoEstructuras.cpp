...
int main(int argc, char *argv[])
{
    ...
    elseif(strcmp(comando, ayuda) == 0)
    {
        ...
        cout<<"Ademas se incluyen los comandos ayuda de cada comando, ayuda_nombre_del_comando \n";
